! function (t) {
    ...
    if (t(window).on("load", (function () {
            ...
            t(this).scrollTop() > 500 ? t(".sticky-wrapper").addClass("") : t(".sticky-wrapper").removeClass("")
    ...
    }, t(".counter-list").length && t(".counter-list").countdown(), t(".single-select").length && t(".single-select").niceSelect(), window.addEventListener("", (function (t) {
        t.preventDefault()
